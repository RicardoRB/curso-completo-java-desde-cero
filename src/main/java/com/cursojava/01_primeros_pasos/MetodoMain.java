package com.cursojava.01_primeros_pasos;
...
public class MetodoMain {
    public static void main(String[] args) {
        ...
        if (args.length > 0) {
            ...
            System.out.println("  mvn compile exec:java -Dexec.mainClass=\"com.cursojava.01_primeros_pasos.MetodoMain\" -Dexec.args=\"Juan 25\"");
        }
