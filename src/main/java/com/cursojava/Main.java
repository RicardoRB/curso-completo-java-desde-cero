...
import com.cursojava.01_primeros_pasos.HolaMundo;
import com.cursojava.02_variables.VariablesYT;
import com.cursojava.03_operadores.OperadoresAritmeticos;
import com.cursojava.04_condiciones.CondicionesIfElse;
import com.cursojava.05_bucles.BucleFor;
import com.cursojava.06_arrays.ArraysBasicos;
import com.cursojava.07_poo.ClasesYObjetos;
import com.cursojava.08_avanzados.ArrayListJava;
 ...
 * 
 * Para ejecutar:
 *   mvn compile exec:java -Dexec.mainClass="com.cursojava.Main"
 */
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("  mvn compile exec:java -Dexec.mainClass=\"com.cursojava.<paquete>.<Clase>\"");
        System.out.println();
        System.out.println("Ejemplos de ejecucion:");
        System.out.println("  mvn compile exec:java -Dexec.mainClass=\"com.cursojava.01_primeros_pasos.HolaMundo\"");
        System.out.println("  mvn compile exec:java -Dexec.mainClass=\"com.cursojava.02_variables.VariablesYT\"");
        System.out.println("  mvn compile exec:java -Dexec.mainClass=\"com.cursojava.07_poo.ClasesYObjetos\"");
        System.out.println();
